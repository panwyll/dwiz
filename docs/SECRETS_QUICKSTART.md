...
2. Find secret: `dwiz-dev/api-keys`
...
# Test retrieval
secret = get_secret("dwiz-dev/api-keys")
...
**Access denied error?**
- Run `dwiz up dev` to update IAM permissions
- Verify secret name follows pattern: `dwiz-<env>/*`
